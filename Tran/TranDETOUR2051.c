...
label_4:;
  ...
  int v24_r7 = atomic_load_explicit(&vars[0+v21_r6], memory_order_seq_cst);
  int v44 = (v16_r1 == 1);
...
label_5:;
  ...
  int v26_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v46 = (v26_r3 == 1);
  atomic_store_explicit(&atom_4_r3_1, v46, memory_order_seq_cst);
    end;
return NULL;
}
