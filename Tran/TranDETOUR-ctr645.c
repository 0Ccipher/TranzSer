...
label_4:;
  ...
  int v24_r6 = atomic_load_explicit(&vars[0+v21_r5], memory_order_seq_cst);
  int v34 = (v18_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v34, memory_order_seq_cst);
  int v35 = (v24_r6 == 0);
  atomic_store_explicit(&atom_3_r6_0, v35, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v28 = atomic_load_explicit(&atom_3_r6_0, memory_order_seq_cst);
