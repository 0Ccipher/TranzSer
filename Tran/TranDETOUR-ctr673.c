...
label_4:;
  ...
  int v27_r4 = atomic_load_explicit(&vars[9+v24_r3], memory_order_seq_cst);
  int v29_r6 = atomic_load_explicit(&vars[10], memory_order_seq_cst);
  int v30_cmpeq = (v29_r6 == v29_r6);
  if (v30_cmpeq)  goto lbl_LC03; else goto lbl_LC03;
lbl_LC03:;
...
int main(int argc, char **argv){
  ...
  int v31 = atomic_load_explicit(&atom_0_r1_1, memory_order_seq_cst);
