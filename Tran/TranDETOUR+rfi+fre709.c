...
label_3:;
  ...
  int v39 = (v12_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v39, memory_order_seq_cst);
    end;
return NULL;
}
...
label_4:;
  ...
  atomic_store_explicit(&vars[3+v15_r4], 1, memory_order_seq_cst);
...
label_5:;
  begin;
  int v17_r1 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v18_r3 = v17_r1 ^ v17_r1;
  atomic_store_explicit(&vars[4+v18_r3], 1, memory_order_seq_cst);
  int v20_r6 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v21_r7 = v20_r6 ^ v20_r6;
  int v24_r8 = atomic_load_explicit(&vars[0+v21_r7], memory_order_seq_cst);
  int v40 = (v17_r1 == 2);
  atomic_store_explicit(&atom_4_r1_2, v40, memory_order_seq_cst);
  int v41 = (v24_r8 == 0);
...
int main(int argc, char **argv){
  ...
  int v28 = atomic_load_explicit(&atom_1_r4_0, memory_order_seq_cst);
  ...
  int v31 = atomic_load_explicit(&atom_4_r8_0, memory_order_seq_cst);
