...
label_3:;
  ...
  int v10_r7 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v29 = (v10_r7 == 0);
  atomic_store_explicit(&atom_2_r7_0, v29, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(&vars[6], memory_order_seq_cst);
  int v18 = (v17 == 2);
  ...
  int v23 = atomic_load_explicit(&atom_4_r3_0, memory_order_seq_cst);
