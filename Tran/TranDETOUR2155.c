...
label_2:;
  ...
  int v42 = (v2_r1 == 2);
  atomic_store_explicit(&atom_1_r1_2, v42, memory_order_seq_cst);
    end;
return NULL;
}
...
label_3:;
  ...
  int v43 = (v6_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v43, memory_order_seq_cst);
  int v44 = (v14_r7 == 0);
  atomic_store_explicit(&atom_2_r7_0, v44, memory_order_seq_cst);
    end;
return NULL;
}
...
label_4:;
  ...
  int v18_r4 = v17_r4 + 1;
  atomic_store_explicit(&vars[4], v18_r4, memory_order_seq_cst);
  int v20_r6 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v45 = (v20_r6 == 1);
  atomic_store_explicit(&atom_3_r6_1, v45, memory_order_seq_cst);
    end;
return NULL;
}
...
label_5:;
  ...
  int v24_r4 = v23_r4 + 1;
  atomic_store_explicit(&vars[0], v24_r4, memory_order_seq_cst);
  int v26_r6 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v46 = (v26_r6 == 1);
  atomic_store_explicit(&atom_4_r6_1, v46, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v27 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v28 = (v27 == 2);
  ...
  int v33 = atomic_load_explicit(&atom_2_r7_0, memory_order_seq_cst);
