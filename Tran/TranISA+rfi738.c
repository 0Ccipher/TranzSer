...
label_1:;
  ...
  int v37 = (v6_r5 == 1);
  atomic_store_explicit(&atom_0_r5_1, v37, memory_order_seq_cst);
    end;
return NULL;
}
...
label_3:;
  ...
  int v24_r6 = v23_r6 + 1;
  atomic_store_explicit(&vars[0], v24_r6, memory_order_seq_cst);
  int v40 = (v18_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v40, memory_order_seq_cst);
  int v41 = (v22_r5 == 1);
  atomic_store_explicit(&atom_2_r5_1, v41, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v26 = atomic_load_explicit(&atom_0_r5_1, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_1_r1_1, memory_order_seq_cst);
  int v28 = atomic_load_explicit(&atom_1_r5_1, memory_order_seq_cst);
  int v29 = atomic_load_explicit(&atom_2_r1_1, memory_order_seq_cst);
  int v30 = atomic_load_explicit(&atom_2_r5_1, memory_order_seq_cst);
