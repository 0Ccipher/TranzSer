...
label_3:;
  ...
  int v38 = (v12_r8 == 0);
  atomic_store_explicit(&atom_2_r8_0, v38, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v26 = atomic_load_explicit(&atom_2_r8_0, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_4_r1_2, memory_order_seq_cst);
