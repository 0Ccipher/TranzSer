...
label_4:;
  ...
  int v22_r7 = atomic_load_explicit(&vars[0+v19_r6], memory_order_seq_cst);
  int v39 = (v14_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v39, memory_order_seq_cst);
  int v40 = (v22_r7 == 0);
  atomic_store_explicit(&atom_3_r7_0, v40, memory_order_seq_cst);
    end;
return NULL;
}
...
label_5:;
  ...
  int v41 = (v24_r3 == 1);
  atomic_store_explicit(&atom_4_r3_1, v41, memory_order_seq_cst);
    end;
return NULL;
}
