...
label_5:;
  ...
  int v31_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v44 = (v29_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v44, memory_order_seq_cst);
  int v45 = (v31_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v45, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v36 = atomic_load_explicit(&atom_4_r3_0, memory_order_seq_cst);
