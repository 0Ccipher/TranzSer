...
label_3:;
  ...
  int v13_r8 = atomic_load_explicit(&vars[0+v10_r7], memory_order_seq_cst);
  int v20 = (v5_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v20, memory_order_seq_cst);
  int v21 = (v13_r8 == 0);
  atomic_store_explicit(&atom_2_r8_0, v21, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(&atom_2_r8_0, memory_order_seq_cst);
