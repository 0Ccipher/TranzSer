...
label_4:;
  ...
  int v19_r8 = v18_r6 ^ v18_r6;
  int v22_r9 = atomic_load_explicit(&vars[0+v19_r8], memory_order_seq_cst);
  int v32 = (v12_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v32, memory_order_seq_cst);
  int v33 = (v22_r9 == 0);
  atomic_store_explicit(&atom_3_r9_0, v33, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v26 = atomic_load_explicit(&atom_3_r9_0, memory_order_seq_cst);
