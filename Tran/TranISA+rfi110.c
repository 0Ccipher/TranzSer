...
label_4:;
  ...
  atomic_store_explicit(&vars[0+v16_r4], 1, memory_order_seq_cst);
  int v18_r7 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v40 = (v15_r3 == 2);
  atomic_store_explicit(&atom_3_r3_2, v40, memory_order_seq_cst);
  int v41 = (v18_r7 == 1);
  atomic_store_explicit(&atom_3_r7_1, v41, memory_order_seq_cst);
    end;
return NULL;
}
