...
label_2:;
  ...
  atomic_store_explicit(&vars[4+v9_r8], 1, memory_order_seq_cst);
  int v22 = (v5_r1 == 1);
...
void *t2(void *arg){
 begin;
label_3:;
  int v11_r1 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v12_r3 = v11_r1 ^ v11_r1;
  atomic_store_explicit(&vars[5+v12_r3], 1, memory_order_seq_cst);
  int v14_r6 = atomic_load_explicit(&vars[6], memory_order_seq_cst);
  int v15_r8 = v14_r6 ^ v14_r6;
  atomic_store_explicit(&vars[0+v15_r8], 1, memory_order_seq_cst);
  int v23 = (v11_r1 == 1);
