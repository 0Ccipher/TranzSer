...
label_2:;
  ...
  int v30 = (v4_r3 == 0);
  atomic_store_explicit(&atom_1_r3_0, v30, memory_order_seq_cst);
    end;
return NULL;
}
...
label_5:;
  ...
  int v16_r7 = v15_r5 ^ v15_r5;
  int v19_r8 = atomic_load_explicit(&vars[0+v16_r7], memory_order_seq_cst);
  int v32 = (v11_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v32, memory_order_seq_cst);
  int v33 = (v19_r8 == 0);
  atomic_store_explicit(&atom_4_r8_0, v33, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v21 = atomic_load_explicit(&atom_1_r3_0, memory_order_seq_cst);
  ...
  int v24 = atomic_load_explicit(&atom_4_r8_0, memory_order_seq_cst);
