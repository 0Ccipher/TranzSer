...
label_5:;
  ...
  int v17_r6 = atomic_load_explicit(&vars[0+v14_r5], memory_order_seq_cst);
  int v30 = (v11_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v30, memory_order_seq_cst);
  int v31 = (v17_r6 == 0);
  atomic_store_explicit(&atom_4_r6_0, v31, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v22 = atomic_load_explicit(&atom_4_r6_0, memory_order_seq_cst);
