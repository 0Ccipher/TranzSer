...
label_2:;
  ...
  int v34 = (v6_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v34, memory_order_seq_cst);
    end;
return NULL;
}
...
label_5:;
  ...
  int v20_r7 = atomic_load_explicit(&vars[0+v17_r6], memory_order_seq_cst);
  int v36 = (v12_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v36, memory_order_seq_cst);
  int v37 = (v20_r7 == 0);
  atomic_store_explicit(&atom_4_r7_0, v37, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v25 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_4_r1_1, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_4_r7_0, memory_order_seq_cst);
