...
label_4:;
  ...
  int v16_r8 = atomic_load_explicit(&vars[0+v13_r7], memory_order_seq_cst);
  int v26 = (v8_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v26, memory_order_seq_cst);
  int v27 = (v16_r8 == 0);
  atomic_store_explicit(&atom_3_r8_0, v27, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(&atom_3_r8_0, memory_order_seq_cst);
