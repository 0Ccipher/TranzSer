...
label_4:;
  ...
  int v18_r3 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v20_r5 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
...
void *t4(void *arg){
 begin;
label_5:;
  int v23_r1 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
