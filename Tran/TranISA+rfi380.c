...
label_1:;
  ...
  int v32 = (v2_r1 == 1);
  atomic_store_explicit(&atom_0_r1_1, v32, memory_order_seq_cst);
  int v33 = (v5_r6 == 1);
  atomic_store_explicit(&atom_0_r6_1, v33, memory_order_seq_cst);
    end;
return NULL;
}
...
label_2:;
  ...
  int v35 = (v12_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v35, memory_order_seq_cst);
    end;
return NULL;
}
...
label_3:;
  ...
  atomic_store_explicit(&vars[0+v20_r6], 1, memory_order_seq_cst);
  int v36 = (v15_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v36, memory_order_seq_cst);
  int v37 = (v19_r5 == 1);
  atomic_store_explicit(&atom_2_r5_1, v37, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v22 = atomic_load_explicit(&atom_0_r6_1, memory_order_seq_cst);
  int v23 = atomic_load_explicit(&atom_1_r1_1, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_1_r5_1, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_2_r1_1, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_2_r5_1, memory_order_seq_cst);
