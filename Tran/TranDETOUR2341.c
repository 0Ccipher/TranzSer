...
label_2:;
  ...
  int v36 = (v10_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v36, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v26 = atomic_load_explicit(&atom_1_r7_0, memory_order_seq_cst);
  ...
  int v29 = atomic_load_explicit(&atom_4_r3_1, memory_order_seq_cst);
