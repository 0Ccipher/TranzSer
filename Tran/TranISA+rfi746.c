...
label_3:;
  ...
  int v18_r5 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v19_r6 = v18_r5 ^ v18_r5;
  atomic_store_explicit(&vars[5+v19_r6], 1, memory_order_seq_cst);
  int v38 = (v14_r1 == 1);
...
label_4:;
  begin;
  int v21_r1 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v22_r3 = v21_r1 ^ v21_r1;
  int v23_r3 = v22_r3 + 1;
  atomic_store_explicit(&vars[0], v23_r3, memory_order_seq_cst);
  int v40 = (v21_r1 == 1);
