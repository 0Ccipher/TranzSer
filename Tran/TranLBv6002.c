...
label_4:;
  begin;
  int v14_r1 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v15_r3 = v14_r1 ^ v14_r1;
  int v16_r3 = v15_r3 + 1;
  atomic_store_explicit(&vars[9], v16_r3, memory_order_seq_cst);
  atomic_store_explicit(&vars[10], 1, memory_order_seq_cst);
