...
label_3:;
  ...
  int v37 = (v5_r1 == 2);
  atomic_store_explicit(&atom_2_r1_2, v37, memory_order_seq_cst);
    end;
return NULL;
}
...
label_4:;
  ...
  int v38 = (v8_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v38, memory_order_seq_cst);
  int v39 = (v12_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v39, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v25 = atomic_load_explicit(&atom_2_r1_2, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_3_r4_0, memory_order_seq_cst);
  int v28 = atomic_load_explicit(&atom_4_r7_1, memory_order_seq_cst);
