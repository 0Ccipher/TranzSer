...
label_5:;
  ...
  atomic_store_explicit(&vars[4+v16_r3], 1, memory_order_seq_cst);
  int v18_r6 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v19_r7 = v18_r6 ^ v18_r6;
  int v22_r8 = atomic_load_explicit(&vars[0+v19_r7], memory_order_seq_cst);
  int v41 = (v15_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v41, memory_order_seq_cst);
  int v42 = (v22_r8 == 0);
  atomic_store_explicit(&atom_4_r8_0, v42, memory_order_seq_cst);
    end;
return NULL;
}
