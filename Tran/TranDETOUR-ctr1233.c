...
lbl_LC00:;
  ...
  int v39 = (v2_r1 == 1);
  atomic_store_explicit(&atom_0_r1_1, v39, memory_order_seq_cst);
    end;
return NULL;
}
...
label_4:;
  ...
  int v24_cmpeq = (v23_r1 == v23_r1);
  if (v24_cmpeq)  goto lbl_LC03; else goto lbl_LC03;
lbl_LC03:;
...
label_5:;
  begin;
  int v26_r1 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v28_r3 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
  int v29_cmpeq = (v28_r3 == v28_r3);
  if (v29_cmpeq)  goto lbl_LC04; else goto lbl_LC04;
lbl_LC04:;
