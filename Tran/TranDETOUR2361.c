...
label_3:;
  ...
  int v43 = (v18_r7 == 0);
  atomic_store_explicit(&atom_2_r7_0, v43, memory_order_seq_cst);
    end;
return NULL;
}
...
label_4:;
  ...
  int v22_r4 = v21_r4 + 1;
  atomic_store_explicit(&vars[5], v22_r4, memory_order_seq_cst);
    end;
return NULL;
}
...
label_5:;
  begin;
  int v24_r1 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v25_r3 = v24_r1 ^ v24_r1;
  int v26_r3 = v25_r3 + 1;
  atomic_store_explicit(&vars[0], v26_r3, memory_order_seq_cst);
  int v28_r5 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v44 = (v24_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v44, memory_order_seq_cst);
  int v45 = (v28_r5 == 1);
  atomic_store_explicit(&atom_4_r5_1, v45, memory_order_seq_cst);
    end;
return NULL;
}
