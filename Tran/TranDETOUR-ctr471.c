...
label_5:;
  ...
  int v27_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v40 = (v25_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v40, memory_order_seq_cst);
  int v41 = (v27_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v41, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v32 = atomic_load_explicit(&atom_4_r3_0, memory_order_seq_cst);
