...
label_2:;
  ...
  int v12_r5 = v11_r5 + 1;
  atomic_store_explicit(&vars[2], v12_r5, memory_order_seq_cst);
  int v33 = (v6_r1 == 1);
...
label_4:;
  ...
  int v22_r4 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v23_r5 = v22_r4 ^ v22_r4;
  int v24_r5 = v23_r5 + 1;
  atomic_store_explicit(&vars[0], v24_r5, memory_order_seq_cst);
  int v35 = (v18_r1 == 1);
