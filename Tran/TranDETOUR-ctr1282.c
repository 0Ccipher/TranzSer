...
label_5:;
  ...
  int v27_r4 = atomic_load_explicit(&vars[8+v24_r3], memory_order_seq_cst);
  int v29_r6 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
