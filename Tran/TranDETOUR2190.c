...
label_4:;
  ...
  int v17_r6 = v16_r5 ^ v16_r5;
  int v20_r7 = atomic_load_explicit(&vars[4+v17_r6], memory_order_seq_cst);
  int v44 = (v12_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v44, memory_order_seq_cst);
  int v45 = (v20_r7 == 0);
  atomic_store_explicit(&atom_3_r7_0, v45, memory_order_seq_cst);
    end;
return NULL;
}
