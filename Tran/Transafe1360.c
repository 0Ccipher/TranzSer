...
label_3:;
  ...
  int v14_r5 = atomic_load_explicit(&vars[6], memory_order_seq_cst);
  int v15_r7 = v14_r5 ^ v14_r5;
  int v16_r7 = v15_r7 + 1;
  atomic_store_explicit(&vars[7], v16_r7, memory_order_seq_cst);
  int v28 = (v10_r1 == 1);
...
int main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v20 = (v19 == 2);
  int v21 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v22 = (v21 == 2);
  int v23 = atomic_load_explicit(&atom_2_r1_1, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_3_r3_0, memory_order_seq_cst);
