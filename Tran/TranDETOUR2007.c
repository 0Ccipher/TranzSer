...
label_5:;
  ...
  int v24_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v47 = (v24_r3 == 1);
  atomic_store_explicit(&atom_4_r3_1, v47, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v35 = atomic_load_explicit(&atom_4_r3_1, memory_order_seq_cst);
