...
label_5:;
  ...
  int v13_r3 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v14_r4 = v13_r3 ^ v13_r3;
  int v17_r5 = atomic_load_explicit(&vars[0+v14_r4], memory_order_seq_cst);
  int v40 = (v17_r5 == 0);
  atomic_store_explicit(&atom_4_r5_0, v40, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v28 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
