...
void *t3(void *arg){
 begin;
label_4:;
  int v16_r1 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v18_r3 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v20_r4 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v21_r5 = v20_r4 ^ v20_r4;
  int v22_r5 = v21_r5 + 1;
  atomic_store_explicit(&vars[0], v22_r5, memory_order_seq_cst);
  int v33 = (v16_r1 == 1);
