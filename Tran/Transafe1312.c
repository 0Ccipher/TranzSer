...
label_2:;
  ...
  int v27 = (v10_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v27, memory_order_seq_cst);
    end;
return NULL;
}
...
label_3:;
  ...
  int v14_r5 = v13_r5 + 1;
  atomic_store_explicit(&vars[6], v14_r5, memory_order_seq_cst);
  int v16_r7 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v28 = (v16_r7 == 0);
  atomic_store_explicit(&atom_2_r7_0, v28, memory_order_seq_cst);
    end;
return NULL;
}
...
label_4:;
  ...
  int v29 = (v18_r3 == 0);
  atomic_store_explicit(&atom_3_r3_0, v29, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
  int v21 = atomic_load_explicit(&atom_2_r7_0, memory_order_seq_cst);
  int v22 = atomic_load_explicit(&atom_3_r3_0, memory_order_seq_cst);
