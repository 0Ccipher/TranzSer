...
label_3:;
  ...
  int v18_r3 = v17_r3 + 1;
  atomic_store_explicit(&vars[5], v18_r3, memory_order_seq_cst);
  int v20_r5 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v21_r6 = v20_r5 ^ v20_r5;
  atomic_store_explicit(&vars[0+v21_r6], 1, memory_order_seq_cst);
  int v37 = (v16_r1 == 1);
