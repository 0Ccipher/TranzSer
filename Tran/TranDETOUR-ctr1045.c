...
label_2:;
  ...
  int v34 = (v8_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v34, memory_order_seq_cst);
    end;
return NULL;
}
...
label_5:;
  ...
  int v17_r4 = atomic_load_explicit(&vars[4+v14_r3], memory_order_seq_cst);
  int v19_r6 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v20_r8 = v19_r6 ^ v19_r6;
  int v23_r9 = atomic_load_explicit(&vars[0+v20_r8], memory_order_seq_cst);
  int v36 = (v13_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v36, memory_order_seq_cst);
  int v37 = (v23_r9 == 0);
  atomic_store_explicit(&atom_4_r9_0, v37, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v25 = atomic_load_explicit(&atom_1_r6_0, memory_order_seq_cst);
  ...
  int v28 = atomic_load_explicit(&atom_4_r9_0, memory_order_seq_cst);
