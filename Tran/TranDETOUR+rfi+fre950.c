...
label_4:;
  ...
  int v11_r4 = atomic_load_explicit(&vars[2+v8_r3], memory_order_seq_cst);
  int v32 = (v7_r1 == 2);
...
int main(int argc, char **argv){
  ...
  int v23 = atomic_load_explicit(&atom_3_r4_0, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
