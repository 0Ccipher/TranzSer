...
label_5:;
  ...
  int v21_r4 = atomic_load_explicit(&vars[7+v18_r3], memory_order_seq_cst);
  int v23_r6 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
...
int main(int argc, char **argv){
  ...
  int v29 = atomic_load_explicit(&atom_1_r7_0, memory_order_seq_cst);
