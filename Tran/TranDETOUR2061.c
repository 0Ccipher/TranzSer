...
label_3:;
  ...
  int v18_r7 = atomic_load_explicit(&vars[0+v15_r6], memory_order_seq_cst);
  int v32 = (v10_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v32, memory_order_seq_cst);
  int v33 = (v18_r7 == 0);
  atomic_store_explicit(&atom_2_r7_0, v33, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v25 = atomic_load_explicit(&atom_2_r7_0, memory_order_seq_cst);
