...
label_5:;
  ...
  int v27_r6 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v28_r8 = v27_r6 ^ v27_r6;
  int v31_r9 = atomic_load_explicit(&vars[0+v28_r8], memory_order_seq_cst);
  int v44 = (v21_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v44, memory_order_seq_cst);
  int v45 = (v31_r9 == 0);
  atomic_store_explicit(&atom_4_r9_0, v45, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v36 = atomic_load_explicit(&atom_4_r9_0, memory_order_seq_cst);
