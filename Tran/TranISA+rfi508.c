...
label_2:;
  ...
  int v14_r6 = v13_r6 + 1;
  atomic_store_explicit(&vars[4], v14_r6, memory_order_seq_cst);
  int v35 = (v8_r1 == 1);
...
label_3:;
  ...
  atomic_store_explicit(&vars[5+v17_r3], 1, memory_order_seq_cst);
  int v19_r6 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v20_r7 = v19_r6 ^ v19_r6;
  int v21_r7 = v20_r7 + 1;
  atomic_store_explicit(&vars[0], v21_r7, memory_order_seq_cst);
  int v37 = (v16_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v37, memory_order_seq_cst);
  int v38 = (v19_r6 == 1);
  atomic_store_explicit(&atom_2_r6_1, v38, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v27 = atomic_load_explicit(&atom_2_r6_1, memory_order_seq_cst);
