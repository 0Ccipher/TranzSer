...
label_1:;
  ...
  int v38 = (v2_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v38, memory_order_seq_cst);
    end;
return NULL;
}
...
label_4:;
  ...
  int v16_r5 = atomic_load_explicit(&vars[2+v13_r4], memory_order_seq_cst);
  int v41 = (v16_r5 == 0);
...
int main(int argc, char **argv){
  ...
  int v26 = (v25 == 2);
  int v27 = atomic_load_explicit(&atom_0_r3_1, memory_order_seq_cst);
  int v28 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
