...
label_2:;
  ...
  int v26 = (v8_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v26, memory_order_seq_cst);
    end;
return NULL;
}
...
label_5:;
  ...
  int v15_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v28 = (v13_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v28, memory_order_seq_cst);
  int v29 = (v15_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v29, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(&atom_1_r6_0, memory_order_seq_cst);
