...
label_5:;
  ...
  int v18_r8 = v17_r6 ^ v17_r6;
  int v21_r9 = atomic_load_explicit(&vars[0+v18_r8], memory_order_seq_cst);
  int v34 = (v11_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v34, memory_order_seq_cst);
  int v35 = (v21_r9 == 0);
  atomic_store_explicit(&atom_4_r9_0, v35, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v26 = atomic_load_explicit(&atom_4_r9_0, memory_order_seq_cst);
