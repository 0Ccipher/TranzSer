...
label_4:;
  ...
  int v20_r4 = atomic_load_explicit(&vars[4+v17_r3], memory_order_seq_cst);
  int v44 = (v16_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v44, memory_order_seq_cst);
  int v45 = (v20_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v45, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v34 = atomic_load_explicit(&atom_3_r4_0, memory_order_seq_cst);
