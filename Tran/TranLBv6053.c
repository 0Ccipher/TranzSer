...
label_4:;
  begin;
  int v14_r1 = atomic_load_explicit(&vars[6], memory_order_seq_cst);
  int v15_r3 = v14_r1 ^ v14_r1;
  int v16_r3 = v15_r3 + 1;
  atomic_store_explicit(&vars[7], v16_r3, memory_order_seq_cst);
...
label_5:;
  begin;
  int v18_r1 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v19_r3 = v18_r1 ^ v18_r1;
  int v20_r3 = v19_r3 + 1;
  atomic_store_explicit(&vars[9], v20_r3, memory_order_seq_cst);
