...
label_5:;
  begin;
  int v29_r1 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
  int v30_r3 = v29_r1 ^ v29_r1;
  int v33_r4 = atomic_load_explicit(&vars[0+v30_r3], memory_order_seq_cst);
  int v46 = (v29_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v46, memory_order_seq_cst);
  int v47 = (v33_r4 == 0);
  atomic_store_explicit(&atom_4_r4_0, v47, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v38 = atomic_load_explicit(&atom_4_r4_0, memory_order_seq_cst);
