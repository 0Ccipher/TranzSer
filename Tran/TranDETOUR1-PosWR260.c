...
label_1:;
  ...
  int v36 = (v6_r5 == 0);
  atomic_store_explicit(&atom_0_r5_0, v36, memory_order_seq_cst);
    end;
return NULL;
}
...
label_2:;
  ...
  int v37 = (v11_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v37, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v28 = atomic_load_explicit(&atom_1_r7_1, memory_order_seq_cst);
