...
label_4:;
  ...
  int v17_r4 = atomic_load_explicit(&vars[0+v14_r3], memory_order_seq_cst);
  int v36 = (v13_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v36, memory_order_seq_cst);
  int v37 = (v17_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v37, memory_order_seq_cst);
    end;
return NULL;
}
