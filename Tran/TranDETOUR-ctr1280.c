...
label_5:;
  ...
  int v21_r4 = atomic_load_explicit(&vars[5+v18_r3], memory_order_seq_cst);
  int v23_r6 = atomic_load_explicit(&vars[6], memory_order_seq_cst);
  int v24_r8 = v23_r6 ^ v23_r6;
  int v27_r9 = atomic_load_explicit(&vars[0+v24_r8], memory_order_seq_cst);
  int v40 = (v17_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v40, memory_order_seq_cst);
  int v41 = (v27_r9 == 0);
  atomic_store_explicit(&atom_4_r9_0, v41, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v32 = atomic_load_explicit(&atom_4_r9_0, memory_order_seq_cst);
