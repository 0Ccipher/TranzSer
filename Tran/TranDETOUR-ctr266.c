...
label_3:;
  ...
  int v12_r5 = v11_r3 ^ v11_r3;
  int v15_r6 = atomic_load_explicit(&vars[5+v12_r5], memory_order_seq_cst);
  int v17_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v24 = (v9_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v24, memory_order_seq_cst);
  int v25 = (v17_r8 == 0);
  atomic_store_explicit(&atom_2_r8_0, v25, memory_order_seq_cst);
    end;
return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(&atom_2_r8_0, memory_order_seq_cst);
