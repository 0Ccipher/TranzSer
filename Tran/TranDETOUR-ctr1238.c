...
label_5:;
  ...
  int v26_r4 = atomic_load_explicit(&vars[8+v23_r3], memory_order_seq_cst);
  int v28_r6 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
  int v29_cmpeq = (v28_r6 == v28_r6);
