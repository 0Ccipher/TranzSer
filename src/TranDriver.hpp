...
#ifndef __Tran_MO_DRIVER_HPP__
#define __Tran_MO_DRIVER_HPP__

#include "GenMCDriver.hpp"

class TranDriver : public GenMCDriver {

public:
	TranDriver(std::shared_ptr<const Config> conf, std::unique_ptr<llvm::Module> mod,
...
private:
	...
	/* Returns true if aLab and bLab are in an Tran data race*/
