...
label_2:;
  ...
  atomic_store_explicit(&vars[3+v10_r3], 1, memory_order_seq_cst);
  int v12_r6 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v13_r7 = v12_r6 ^ v12_r6;
  int v14_r7 = v13_r7 + 1;
  atomic_store_explicit(&vars[4], v14_r7, memory_order_seq_cst);
  int v35 = (v9_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v35, memory_order_seq_cst);
  int v36 = (v12_r6 == 1);
  atomic_store_explicit(&atom_1_r6_1, v36, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v25 = atomic_load_explicit(&atom_1_r6_1, memory_order_seq_cst);
