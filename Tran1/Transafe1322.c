...
label_2:;
  ...
  int v29 = (v6_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v29, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_3:;
  ...
  int v30 = (v8_r3 == 0);
  atomic_store_explicit(&atom_2_r3_0, v30, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v12_r5 = v11_r5 + 1;
  atomic_store_explicit(&vars[5], v12_r5, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v23 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
