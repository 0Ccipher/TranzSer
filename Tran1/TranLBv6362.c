...
label_4:;
  ...
  int v22_r4 = atomic_load_explicit(&vars[6+v19_r3], memory_order_seq_cst);
...
void *t4(void *arg){
 begin;
label_5:;
  int v24_r1 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v25_r3 = v24_r1 ^ v24_r1;
  int v28_r4 = atomic_load_explicit(&vars[8+v25_r3], memory_order_seq_cst);
