...
label_3:;
  ...
  int v27 = (v8_r6 == 1);
  atomic_store_explicit(&atom_2_r6_1, v27, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v28 = (v14_r5 == 0);
  atomic_store_explicit(&atom_3_r5_0, v28, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v19 = atomic_load_explicit(&atom_2_r6_1, memory_order_seq_cst);
