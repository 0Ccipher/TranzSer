...
label_4:;
  ...
  atomic_store_explicit(&vars[2+v8_r3], 1, memory_order_seq_cst);
  ...
  int v37 = (v7_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v37, memory_order_seq_cst);
  int v38 = (v10_r6 == 1);
  atomic_store_explicit(&atom_3_r6_1, v38, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v15_r3 = v14_r3 + 1;
  atomic_store_explicit(&vars[0], v15_r3, memory_order_seq_cst);
  int v17_r5 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v39 = (v13_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v39, memory_order_seq_cst);
  int v40 = (v17_r5 == 1);
  atomic_store_explicit(&atom_4_r5_1, v40, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v23 = atomic_load_explicit(&atom_1_r6_1, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_3_r6_1, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_4_r1_1, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_4_r5_1, memory_order_seq_cst);
