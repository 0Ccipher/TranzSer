...
label_3:;
  ...
  int v32 = (v9_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v32, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v15_r5 = atomic_load_explicit(&vars[0+v12_r4], memory_order_seq_cst);
  int v33 = (v15_r5 == 0);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v23 = atomic_load_explicit(&atom_3_r5_0, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_4_r3_1, memory_order_seq_cst);
