...
label_2:;
  ...
  int v32 = (v8_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v32, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v18_r5 = v17_r3 ^ v17_r3;
  int v21_r6 = atomic_load_explicit(&vars[0+v18_r5], memory_order_seq_cst);
  int v34 = (v15_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v34, memory_order_seq_cst);
  int v35 = (v21_r6 == 0);
  atomic_store_explicit(&atom_4_r6_0, v35, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v23 = atomic_load_explicit(&atom_1_r7_0, memory_order_seq_cst);
  ...
  int v26 = atomic_load_explicit(&atom_4_r6_0, memory_order_seq_cst);
