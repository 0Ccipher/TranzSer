...
label_3:;
  ...
  int v40 = (v18_r7 == 0);
  atomic_store_explicit(&atom_2_r7_0, v40, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v28_r4 = atomic_load_explicit(&vars[0+v25_r3], memory_order_seq_cst);
  int v41 = (v24_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v41, memory_order_seq_cst);
  int v42 = (v28_r4 == 0);
  atomic_store_explicit(&atom_4_r4_0, v42, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v31 = atomic_load_explicit(&atom_2_r7_0, memory_order_seq_cst);
  int v32 = atomic_load_explicit(&atom_4_r1_1, memory_order_seq_cst);
  int v33 = atomic_load_explicit(&atom_4_r4_0, memory_order_seq_cst);
