...
label_2:;
  ...
  int v25 = (v10_r8 == 0);
  atomic_store_explicit(&atom_1_r8_0, v25, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v27 = (v16_r5 == 0);
  atomic_store_explicit(&atom_3_r5_0, v27, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v18 = atomic_load_explicit(&atom_1_r8_0, memory_order_seq_cst);
