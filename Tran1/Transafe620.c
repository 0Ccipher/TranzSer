...
label_2:;
  ...
  int v4_r3 = v3_r3 + 1;
  atomic_store_explicit(&vars[4], v4_r3, memory_order_seq_cst);
...
void *t2(void *arg){
 begin;
label_3:;
  int v6_r1 = atomic_load_explicit(&vars[6], memory_order_seq_cst);
  int v7_r3 = v6_r1 ^ v6_r1;
  int v8_r3 = v7_r3 + 1;
  atomic_store_explicit(&vars[7], v8_r3, memory_order_seq_cst);
  int v22 = (v6_r1 == 1);
...
void *t3(void *arg){
 begin;
label_4:;
  int v10_r1 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
