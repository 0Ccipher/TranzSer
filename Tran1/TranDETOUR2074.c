...
label_5:;
  ...
  int v16_r3 = v15_r3 + 1;
  atomic_store_explicit(&vars[3], v16_r3, memory_order_seq_cst);
  int v18_r5 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v29 = atomic_load_explicit(&atom_4_r7_0, memory_order_seq_cst);
