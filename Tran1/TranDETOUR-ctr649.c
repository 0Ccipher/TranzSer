...
label_5:;
  ...
  int v25_r3 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v27_r5 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v28_r7 = v27_r5 ^ v27_r5;
  int v31_r8 = atomic_load_explicit(&vars[0+v28_r7], memory_order_seq_cst);
  int v44 = (v23_r1 == 1);
