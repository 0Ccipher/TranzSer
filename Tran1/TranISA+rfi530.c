...
label_3:;
  ...
  int v35 = (v12_r5 == 1);
  atomic_store_explicit(&atom_2_r5_1, v35, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  atomic_store_explicit(&vars[0+v20_r7], 1, memory_order_seq_cst);
  int v36 = (v16_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v36, memory_order_seq_cst);
  int v37 = (v19_r6 == 1);
  atomic_store_explicit(&atom_3_r6_1, v37, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v24 = atomic_load_explicit(&atom_2_r5_1, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_3_r1_1, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_3_r6_1, memory_order_seq_cst);
