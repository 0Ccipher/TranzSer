...
label_4:;
  ...
  int v20_r6 = atomic_load_explicit(&vars[0+v17_r5], memory_order_seq_cst);
  int v30 = (v14_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v30, memory_order_seq_cst);
  int v31 = (v20_r6 == 0);
  atomic_store_explicit(&atom_3_r6_0, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v24 = atomic_load_explicit(&atom_3_r6_0, memory_order_seq_cst);
