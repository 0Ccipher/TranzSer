...
label_5:;
  ...
  int v19_r4 = atomic_load_explicit(&vars[0+v16_r3], memory_order_seq_cst);
  int v41 = (v15_r1 == 2);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v28 = atomic_load_explicit(&atom_2_r7_1, memory_order_seq_cst);
  int v29 = atomic_load_explicit(&atom_4_r1_2, memory_order_seq_cst);
