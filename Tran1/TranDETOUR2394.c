...
label_2:;
  ...
  int v31 = (v6_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v34 = (v14_r3 == 1);
  atomic_store_explicit(&atom_4_r3_1, v34, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v20 = atomic_load_explicit(&atom_1_r5_1, memory_order_seq_cst);
  int v21 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v22 = atomic_load_explicit(&atom_3_r4_0, memory_order_seq_cst);
  int v23 = atomic_load_explicit(&atom_4_r3_1, memory_order_seq_cst);
