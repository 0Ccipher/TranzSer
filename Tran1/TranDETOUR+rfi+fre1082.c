...
label_3:;
  ...
  int v39 = (v12_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v39, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  atomic_store_explicit(&vars[4+v15_r4], 1, memory_order_seq_cst);
...
label_5:;
  ...
  atomic_store_explicit(&vars[5+v18_r3], 1, memory_order_seq_cst);
...
int main(int argc, char **argv){
  ...
  pthread_join(thr4,NULL);
   ...
   int res = 0;
 begin;
  int v25 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v26 = (v25 == 2);
  ...
  int v29 = atomic_load_explicit(&atom_2_r4_0, memory_order_seq_cst);
