...
label_3:;
  ...
  int v32 = (v9_r5 == 1);
  atomic_store_explicit(&atom_2_r5_1, v32, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  atomic_store_explicit(&vars[0+v12_r4], 1, memory_order_seq_cst);
  int v14_r7 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v33 = (v11_r3 == 2);
  atomic_store_explicit(&atom_3_r3_2, v33, memory_order_seq_cst);
  int v34 = (v14_r7 == 1);
  atomic_store_explicit(&atom_3_r7_1, v34, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v21 = atomic_load_explicit(&atom_2_r5_1, memory_order_seq_cst);
  int v22 = atomic_load_explicit(&atom_3_r3_2, memory_order_seq_cst);
  int v23 = atomic_load_explicit(&atom_3_r7_1, memory_order_seq_cst);
