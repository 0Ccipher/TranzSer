...
label_4:;
  ...
  atomic_store_explicit(&vars[4+v14_r4], 1, memory_order_seq_cst);
  int v16_r7 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v41 = (v16_r7 == 1);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v30 = atomic_load_explicit(&atom_3_r7_1, memory_order_seq_cst);
  int v31 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
