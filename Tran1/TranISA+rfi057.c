...
label_1:;
  ...
  int v28 = (v2_r3 == 2);
  atomic_store_explicit(&atom_0_r3_2, v28, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_3:;
  ...
  atomic_store_explicit(&vars[0+v13_r3], 1, memory_order_seq_cst);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v17 = (v16 == 2);
  int v18 = atomic_load_explicit(&atom_0_r3_2, memory_order_seq_cst);
