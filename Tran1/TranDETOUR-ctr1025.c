...
label_2:;
  ...
  int v31 = (v12_r9 == 0);
  atomic_store_explicit(&atom_1_r9_0, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v20_r6 = atomic_load_explicit(&vars[5+v17_r5], memory_order_seq_cst);
  int v22_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v32 = (v14_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v32, memory_order_seq_cst);
  int v33 = (v22_r8 == 0);
  atomic_store_explicit(&atom_3_r8_0, v33, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v24 = atomic_load_explicit(&atom_1_r9_0, memory_order_seq_cst);
