...
label_4:;
  ...
  int v16_r7 = atomic_load_explicit(&vars[3+v13_r6], memory_order_seq_cst);
  int v37 = (v8_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v37, memory_order_seq_cst);
  int v38 = (v16_r7 == 0);
  atomic_store_explicit(&atom_3_r7_0, v38, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v39 = (v22_r5 == 0);
  atomic_store_explicit(&atom_4_r5_0, v39, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v27 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v28 = atomic_load_explicit(&atom_3_r7_0, memory_order_seq_cst);
  int v29 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
