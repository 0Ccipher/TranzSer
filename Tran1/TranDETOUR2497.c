...
label_4:;
  ...
  int v20_r6 = v19_r6 + 1;
  atomic_store_explicit(&vars[5], v20_r6, memory_order_seq_cst);
  int v42 = (v14_r1 == 1);
...
void *t4(void *arg){
 begin;
label_5:;
  int v22_r1 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v23_r3 = v22_r1 ^ v22_r1;
  int v24_r3 = v23_r3 + 1;
  atomic_store_explicit(&vars[6], v24_r3, memory_order_seq_cst);
  int v26_r5 = atomic_load_explicit(&vars[6], memory_order_seq_cst);
  int v27_r6 = v26_r5 ^ v26_r5;
  int v30_r7 = atomic_load_explicit(&vars[0+v27_r6], memory_order_seq_cst);
  int v43 = (v22_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v43, memory_order_seq_cst);
  int v44 = (v30_r7 == 0);
  atomic_store_explicit(&atom_4_r7_0, v44, memory_order_seq_cst);
  end;
  return NULL;
}
