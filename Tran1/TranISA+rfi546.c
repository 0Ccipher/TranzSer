...
label_5:;
  ...
  atomic_store_explicit(&vars[0+v19_r3], 1, memory_order_seq_cst);
  int v21_r6 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v40 = (v18_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v40, memory_order_seq_cst);
  int v41 = (v21_r6 == 1);
  atomic_store_explicit(&atom_4_r6_1, v41, memory_order_seq_cst);
  end;
  return NULL;
}
