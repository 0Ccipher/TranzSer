...
label_5:;
  ...
  atomic_store_explicit(&vars[4+v17_r3], 1, memory_order_seq_cst);
  int v19_r6 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v20_r7 = v19_r6 ^ v19_r6;
  int v23_r8 = atomic_load_explicit(&vars[0+v20_r7], memory_order_seq_cst);
  int v42 = (v16_r1 == 2);
  atomic_store_explicit(&atom_4_r1_2, v42, memory_order_seq_cst);
  int v43 = (v23_r8 == 0);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v30 = atomic_load_explicit(&atom_2_r7_1, memory_order_seq_cst);
