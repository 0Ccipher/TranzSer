...
label_2:;
  ...
  int v31 = (v8_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v14_r5 = v13_r5 + 1;
  atomic_store_explicit(&vars[5], v14_r5, memory_order_seq_cst);
  int v32 = (v10_r1 == 1);
...
label_5:;
  ...
  int v33 = (v16_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v33, memory_order_seq_cst);
  int v34 = (v20_r5 == 0);
  atomic_store_explicit(&atom_4_r5_0, v34, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v22 = atomic_load_explicit(&atom_1_r7_0, memory_order_seq_cst);
  ...
  int v25 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
