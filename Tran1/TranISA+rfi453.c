...
label_3:;
  ...
  int v15_r5 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v16_r6 = v15_r5 ^ v15_r5;
  int v17_r6 = v16_r6 + 1;
  atomic_store_explicit(&vars[5], v17_r6, memory_order_seq_cst);
  int v35 = (v11_r1 == 1);
...
label_4:;
  ...
  atomic_store_explicit(&vars[0+v20_r3], 1, memory_order_seq_cst);
  int v37 = (v19_r1 == 1);
