...
label_3:;
  ...
  int v15_r5 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v16_cmpeq = (v15_r5 == v15_r5);
...
label_4:;
  ...
  int v20_r3 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v22_r5 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v23_cmpeq = (v22_r5 == v22_r5);
...
void *t4(void *arg){
 begin;
label_5:;
  int v25_r1 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
  int v26_r3 = v25_r1 ^ v25_r1;
  int v29_r4 = atomic_load_explicit(&vars[0+v26_r3], memory_order_seq_cst);
  int v42 = (v25_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v42, memory_order_seq_cst);
  int v43 = (v29_r4 == 0);
  atomic_store_explicit(&atom_4_r4_0, v43, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v34 = atomic_load_explicit(&atom_4_r4_0, memory_order_seq_cst);
