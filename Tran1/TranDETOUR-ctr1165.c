...
label_4:;
  ...
  int v26_r6 = atomic_load_explicit(&vars[0+v23_r5], memory_order_seq_cst);
  int v36 = (v20_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v36, memory_order_seq_cst);
  int v37 = (v26_r6 == 0);
  atomic_store_explicit(&atom_3_r6_0, v37, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v30 = atomic_load_explicit(&atom_3_r6_0, memory_order_seq_cst);
