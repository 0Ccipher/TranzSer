...
label_2:;
  ...
  int v38 = (v6_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v38, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v12_r5 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v13_r6 = v12_r5 ^ v12_r5;
  atomic_store_explicit(&vars[3+v13_r6], 1, memory_order_seq_cst);
  int v39 = (v8_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v39, memory_order_seq_cst);
  int v40 = (v12_r5 == 1);
  atomic_store_explicit(&atom_3_r5_1, v40, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v17_r3 = v16_r3 + 1;
  atomic_store_explicit(&vars[0], v17_r3, memory_order_seq_cst);
  int v19_r5 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v41 = (v15_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v41, memory_order_seq_cst);
  int v42 = (v19_r5 == 1);
  atomic_store_explicit(&atom_4_r5_1, v42, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v23 = (v22 == 2);
  int v24 = atomic_load_explicit(&atom_1_r1_2, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_1_r5_1, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_3_r5_1, memory_order_seq_cst);
