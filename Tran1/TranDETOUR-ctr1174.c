...
label_4:;
  ...
  int v26_cmpeq = (v25_r3 == v25_r3);
  if (v26_cmpeq)  goto lbl_LC03; else goto lbl_LC03;
lbl_LC03:;
...
void *t4(void *arg){
 begin;
label_5:;
  int v28_r1 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
  int v29_cmpeq = (v28_r1 == v28_r1);
