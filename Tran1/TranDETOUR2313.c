...
label_2:;
  ...
  int v33 = (v6_r4 == 0);
  atomic_store_explicit(&atom_1_r4_0, v33, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_3:;
  ...
  int v34 = (v12_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v34, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v36 = (v22_r4 == 0);
  atomic_store_explicit(&atom_4_r4_0, v36, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v24 = atomic_load_explicit(&atom_1_r4_0, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_2_r5_0, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_4_r1_1, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_4_r4_0, memory_order_seq_cst);
