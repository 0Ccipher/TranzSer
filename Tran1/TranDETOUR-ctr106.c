...
label_5:;
  ...
  int v29_r7 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v42 = (v23_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v42, memory_order_seq_cst);
  int v43 = (v29_r7 == 0);
  atomic_store_explicit(&atom_4_r7_0, v43, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v31 = atomic_load_explicit(&atom_1_r9_0, memory_order_seq_cst);
  ...
  int v34 = atomic_load_explicit(&atom_4_r7_0, memory_order_seq_cst);
