...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v22 = atomic_load_explicit(&atom_1_r4_0, memory_order_seq_cst);
  int v23 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_4_r1_2, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_4_r6_1, memory_order_seq_cst);
