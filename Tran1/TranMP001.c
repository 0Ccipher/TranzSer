...
label_1:;
  ...
  int v40 = (v2_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v40, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_2:;
  ...
  int v41 = (v7_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v41, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v43 = (v15_r3 == 1);
  atomic_store_explicit(&atom_3_r3_1, v43, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v17_r3 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v27 = (v26 == 2);
  int v28 = atomic_load_explicit(&atom_0_r3_1, memory_order_seq_cst);
  int v29 = atomic_load_explicit(&atom_1_r7_1, memory_order_seq_cst);
  int v30 = atomic_load_explicit(&atom_2_r5_0, memory_order_seq_cst);
  int v31 = atomic_load_explicit(&atom_3_r3_1, memory_order_seq_cst);
