...
label_1:;
  ...
  int v39 = (v2_r3 == 2);
  atomic_store_explicit(&atom_0_r3_2, v39, memory_order_seq_cst);
  int v40 = (v6_r6 == 1);
  atomic_store_explicit(&atom_0_r6_1, v40, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_2:;
  ...
  int v41 = (v8_r3 == 2);
  atomic_store_explicit(&atom_1_r3_2, v41, memory_order_seq_cst);
  int v42 = (v12_r6 == 1);
...
label_3:;
  ...
  int v43 = (v14_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v43, memory_order_seq_cst);
  int v44 = (v18_r6 == 1);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v24 = (v23 == 2);
  int v25 = atomic_load_explicit(&atom_0_r3_2, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_0_r6_1, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_1_r3_2, memory_order_seq_cst);
  int v28 = atomic_load_explicit(&atom_1_r6_1, memory_order_seq_cst);
  int v29 = atomic_load_explicit(&atom_2_r3_2, memory_order_seq_cst);
  int v30 = atomic_load_explicit(&atom_2_r6_1, memory_order_seq_cst);
