...
label_2:;
  ...
  int v29 = (v10_r8 == 0);
  atomic_store_explicit(&atom_1_r8_0, v29, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v18_r6 = atomic_load_explicit(&vars[5+v15_r5], memory_order_seq_cst);
  int v20_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v30 = (v12_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v30, memory_order_seq_cst);
  int v31 = (v20_r8 == 0);
  atomic_store_explicit(&atom_3_r8_0, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v24 = atomic_load_explicit(&atom_3_r8_0, memory_order_seq_cst);
