...
label_4:;
  ...
  int v13_r3 = v12_r3 + 1;
  atomic_store_explicit(&vars[0], v13_r3, memory_order_seq_cst);
  int v15_r5 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v31 = (v11_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v31, memory_order_seq_cst);
  int v32 = (v15_r5 == 1);
  atomic_store_explicit(&atom_3_r5_1, v32, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v22 = atomic_load_explicit(&atom_3_r5_1, memory_order_seq_cst);
