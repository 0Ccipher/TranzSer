...
label_3:;
  ...
  int v11_r5 = atomic_load_explicit(&vars[0+v8_r4], memory_order_seq_cst);
  int v29 = (v11_r5 == 0);
...
label_4:;
  ...
  int v13_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v30 = (v13_r3 == 1);
  atomic_store_explicit(&atom_3_r3_1, v30, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v21 = atomic_load_explicit(&atom_3_r3_1, memory_order_seq_cst);
