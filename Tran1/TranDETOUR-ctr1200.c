...
label_2:;
  ...
  int v30 = (v8_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v30, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v15_r3 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v16_r5 = v15_r3 ^ v15_r3;
  int v19_r6 = atomic_load_explicit(&vars[0+v16_r5], memory_order_seq_cst);
  int v32 = (v13_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v32, memory_order_seq_cst);
  int v33 = (v19_r6 == 0);
  atomic_store_explicit(&atom_4_r6_0, v33, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v21 = atomic_load_explicit(&atom_1_r6_0, memory_order_seq_cst);
  ...
  int v24 = atomic_load_explicit(&atom_4_r6_0, memory_order_seq_cst);
