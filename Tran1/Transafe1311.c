...
label_5:;
  ...
  int v16_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v30 = (v16_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v30, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v19 = atomic_load_explicit(&atom_2_r7_0, memory_order_seq_cst);
  int v20 = atomic_load_explicit(&atom_3_r3_0, memory_order_seq_cst);
  int v21 = atomic_load_explicit(&atom_4_r3_0, memory_order_seq_cst);
