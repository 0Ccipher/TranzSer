...
label_2:;
  ...
  int v36 = (v6_r4 == 0);
  atomic_store_explicit(&atom_1_r4_0, v36, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v38 = (v13_r1 == 2);
  atomic_store_explicit(&atom_4_r1_2, v38, memory_order_seq_cst);
  int v39 = (v16_r6 == 1);
  atomic_store_explicit(&atom_4_r6_1, v39, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v25 = atomic_load_explicit(&atom_2_r3_1, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_4_r1_2, memory_order_seq_cst);
