...
label_5:;
  ...
  int v28 = (v14_r5 == 0);
  atomic_store_explicit(&atom_4_r5_0, v28, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v18 = atomic_load_explicit(&atom_4_r1_1, memory_order_seq_cst);
  int v19 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
