...
label_2:;
  ...
  int v28 = (v10_r8 == 0);
  atomic_store_explicit(&atom_1_r8_0, v28, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v31 = (v17_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v19 = atomic_load_explicit(&atom_1_r8_0, memory_order_seq_cst);
