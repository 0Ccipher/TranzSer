...
label_3:;
  ...
  int v43 = (v10_r3 == 1);
  atomic_store_explicit(&atom_2_r3_1, v43, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v14_r4 = v13_r4 + 1;
  atomic_store_explicit(&vars[2], v14_r4, memory_order_seq_cst);
  int v16_r6 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v44 = (v16_r6 == 1);
...
label_5:;
  ...
  int v18_r3 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v28 = (v27 == 2);
  int v29 = atomic_load_explicit(&atom_0_r3_1, memory_order_seq_cst);
  int v30 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
  int v31 = atomic_load_explicit(&atom_2_r3_1, memory_order_seq_cst);
