...
label_4:;
  ...
  int v19_r5 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v20_cmpeq = (v19_r5 == v19_r5);
...
void *t4(void *arg){
 begin;
label_5:;
  int v22_r1 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v24_r3 = atomic_load_explicit(&vars[9], memory_order_seq_cst);
  int v25_cmpeq = (v24_r3 == v24_r3);
