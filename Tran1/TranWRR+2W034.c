...
void *t4(void *arg){
 begin;
label_5:;
  atomic_store_explicit(&vars[8], 2, memory_order_seq_cst);
...
int main(int argc, char **argv){
  ...
  pthread_join(thr4,NULL);
   ...
   int res = 0;
 begin;
  int v1 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v2 = (v1 == 2);
  int v3 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v4 = (v3 == 2);
  int v5 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v6 = (v5 == 2);
