...
label_3:;
  ...
  int v16_r6 = v15_r6 + 1;
  atomic_store_explicit(&vars[4], v16_r6, memory_order_seq_cst);
  int v42 = (v10_r1 == 1);
...
label_4:;
  ...
  int v22_r4 = atomic_load_explicit(&vars[5+v19_r3], memory_order_seq_cst);
  int v43 = (v18_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v43, memory_order_seq_cst);
  int v44 = (v22_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v44, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v24_r3 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v25_r4 = v24_r3 ^ v24_r3;
  int v26_r4 = v25_r4 + 1;
  atomic_store_explicit(&vars[0], v26_r4, memory_order_seq_cst);
  int v28_r6 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v45 = (v28_r6 == 1);
