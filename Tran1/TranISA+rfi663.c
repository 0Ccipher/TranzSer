...
label_2:;
  ...
  int v30 = (v9_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v30, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_3:;
  ...
  int v18_r6 = v17_r6 + 1;
  atomic_store_explicit(&vars[0], v18_r6, memory_order_seq_cst);
  int v31 = (v12_r1 == 1);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v21 = atomic_load_explicit(&atom_1_r5_1, memory_order_seq_cst);
