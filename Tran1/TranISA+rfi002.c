...
label_1:;
  ...
  int v37 = (v2_r3 == 2);
  atomic_store_explicit(&atom_0_r3_2, v37, memory_order_seq_cst);
  int v38 = (v5_r7 == 1);
  atomic_store_explicit(&atom_0_r7_1, v38, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_2:;
  ...
  int v39 = (v7_r3 == 2);
  atomic_store_explicit(&atom_1_r3_2, v39, memory_order_seq_cst);
  int v40 = (v10_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v40, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v24 = atomic_load_explicit(&atom_0_r7_1, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_1_r3_2, memory_order_seq_cst);
