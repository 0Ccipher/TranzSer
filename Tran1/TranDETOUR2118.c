...
label_2:;
  ...
  int v43 = (v6_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v43, memory_order_seq_cst);
  end;
  return NULL;
}
...
void *t4(void *arg){
 begin;
label_5:;
  int v18_r1 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v19_r3 = v18_r1 ^ v18_r1;
  int v20_r3 = v19_r3 + 1;
  atomic_store_explicit(&vars[4], v20_r3, memory_order_seq_cst);
  int v22_r5 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  ...
  int v46 = (v26_r7 == 0);
  atomic_store_explicit(&atom_4_r7_0, v46, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v35 = atomic_load_explicit(&atom_4_r7_0, memory_order_seq_cst);
