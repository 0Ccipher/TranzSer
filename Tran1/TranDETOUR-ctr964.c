...
label_5:;
  ...
  int v15_r6 = atomic_load_explicit(&vars[4+v12_r5], memory_order_seq_cst);
  int v17_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v30 = (v9_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v30, memory_order_seq_cst);
  int v31 = (v17_r8 == 0);
  atomic_store_explicit(&atom_4_r8_0, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v22 = atomic_load_explicit(&atom_4_r8_0, memory_order_seq_cst);
