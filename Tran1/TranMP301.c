...
label_4:;
  ...
  int v21_r5 = atomic_load_explicit(&vars[5+v18_r4], memory_order_seq_cst);
  int v40 = (v21_r5 == 0);
  atomic_store_explicit(&atom_3_r5_0, v40, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v23_r3 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v30 = atomic_load_explicit(&atom_2_r8_0, memory_order_seq_cst);
  int v31 = atomic_load_explicit(&atom_3_r5_0, memory_order_seq_cst);
