...
label_2:;
  ...
  int v43 = (v8_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v43, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v18_r4 = v17_r4 + 1;
  atomic_store_explicit(&vars[3], v18_r4, memory_order_seq_cst);
  int v20_r6 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v45 = (v20_r6 == 1);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v32 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
