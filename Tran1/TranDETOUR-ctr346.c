...
label_2:;
  ...
  int v32 = (v8_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v32, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v35 = (v21_r5 == 0);
  atomic_store_explicit(&atom_4_r5_0, v35, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v23 = atomic_load_explicit(&atom_1_r6_0, memory_order_seq_cst);
  ...
  int v26 = atomic_load_explicit(&atom_4_r5_0, memory_order_seq_cst);
