...
label_4:;
  ...
  atomic_store_explicit(&vars[0+v16_r6], 1, memory_order_seq_cst);
  int v29 = (v11_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v29, memory_order_seq_cst);
  int v30 = (v15_r5 == 1);
  atomic_store_explicit(&atom_3_r5_1, v30, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v21 = atomic_load_explicit(&atom_3_r5_1, memory_order_seq_cst);
