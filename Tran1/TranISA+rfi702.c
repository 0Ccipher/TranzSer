...
label_3:;
  ...
  int v14_r6 = v13_r6 + 1;
  atomic_store_explicit(&vars[0], v14_r6, memory_order_seq_cst);
  int v24 = (v8_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v24, memory_order_seq_cst);
  int v25 = (v12_r5 == 1);
  atomic_store_explicit(&atom_2_r5_1, v25, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v18 = atomic_load_explicit(&atom_2_r5_1, memory_order_seq_cst);
