...
label_4:;
  ...
  int v25_r4 = atomic_load_explicit(&vars[9+v22_r3], memory_order_seq_cst);
  int v27_r6 = atomic_load_explicit(&vars[10], memory_order_seq_cst);
  int v28_cmpeq = (v27_r6 == v27_r6);
