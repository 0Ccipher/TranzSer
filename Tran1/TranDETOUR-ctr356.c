...
label_3:;
  ...
  int v15_r6 = atomic_load_explicit(&vars[0+v12_r5], memory_order_seq_cst);
  int v22 = (v9_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v22, memory_order_seq_cst);
  int v23 = (v15_r6 == 0);
  atomic_store_explicit(&atom_2_r6_0, v23, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v18 = atomic_load_explicit(&atom_2_r6_0, memory_order_seq_cst);
