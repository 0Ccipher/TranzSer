...
label_4:;
  ...
  int v34 = (v12_r3 == 2);
  atomic_store_explicit(&atom_3_r3_2, v34, memory_order_seq_cst);
  int v35 = (v15_r7 == 1);
  atomic_store_explicit(&atom_3_r7_1, v35, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v23 = atomic_load_explicit(&atom_3_r3_2, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_3_r7_1, memory_order_seq_cst);
