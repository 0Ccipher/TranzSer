...
label_2:;
  ...
  int v38 = (v12_r9 == 0);
  atomic_store_explicit(&atom_1_r9_0, v38, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_5:;
  ...
  int v23_r3 = atomic_load_explicit(&vars[7], memory_order_seq_cst);
  int v25_r5 = atomic_load_explicit(&vars[8], memory_order_seq_cst);
  int v27_r7 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v40 = (v21_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v40, memory_order_seq_cst);
  int v41 = (v27_r7 == 0);
  atomic_store_explicit(&atom_4_r7_0, v41, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v29 = atomic_load_explicit(&atom_1_r9_0, memory_order_seq_cst);
  ...
  int v32 = atomic_load_explicit(&atom_4_r7_0, memory_order_seq_cst);
