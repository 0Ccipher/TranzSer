...
label_5:;
  ...
  int v14_r4 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v30 = (v10_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v30, memory_order_seq_cst);
  int v31 = (v14_r4 == 1);
  atomic_store_explicit(&atom_4_r4_1, v31, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v22 = atomic_load_explicit(&atom_4_r4_1, memory_order_seq_cst);
