...
label_2:;
  ...
  int v38 = (v8_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v38, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v14_r5 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v29 = atomic_load_explicit(&atom_1_r6_0, memory_order_seq_cst);
