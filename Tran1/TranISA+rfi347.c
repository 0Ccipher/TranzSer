...
label_1:;
  ...
  int v32 = (v5_r6 == 1);
  atomic_store_explicit(&atom_0_r6_1, v32, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_3:;
  ...
  atomic_store_explicit(&vars[0+v19_r6], 1, memory_order_seq_cst);
  int v35 = (v14_r1 == 1);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v21 = atomic_load_explicit(&atom_0_r6_1, memory_order_seq_cst);
