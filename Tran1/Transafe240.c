...
label_3:;
  ...
  int v12_r3 = v11_r3 + 1;
  atomic_store_explicit(&vars[2], v12_r3, memory_order_seq_cst);
  int v36 = (v10_r1 == 1);
...
void *t4(void *arg){
 begin;
label_5:;
  int v18_r1 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v20_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v22_r4 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v38 = (v18_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v38, memory_order_seq_cst);
  int v39 = (v22_r4 == 1);
  atomic_store_explicit(&atom_4_r4_1, v39, memory_order_seq_cst);
  end;
  return NULL;
}
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v29 = atomic_load_explicit(&atom_4_r4_1, memory_order_seq_cst);
