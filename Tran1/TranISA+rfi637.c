...
label_2:;
  ...
  int v37 = (v6_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v37, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_3:;
  ...
  atomic_store_explicit(&vars[4+v15_r6], 1, memory_order_seq_cst);
  int v38 = (v10_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v38, memory_order_seq_cst);
  int v39 = (v14_r5 == 1);
  atomic_store_explicit(&atom_2_r5_1, v39, memory_order_seq_cst);
  end;
  return NULL;
}
...
label_4:;
  ...
  int v19_r3 = v18_r3 + 1;
  atomic_store_explicit(&vars[0], v19_r3, memory_order_seq_cst);
  int v21_r5 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v40 = (v17_r1 == 1);
...
int main(int argc, char **argv){
 ...
 begin;
  ...
  int v29 = atomic_load_explicit(&atom_3_r5_1, memory_order_seq_cst);
